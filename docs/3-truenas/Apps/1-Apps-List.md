...
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/bitmagnet.png" width="48" height="36" /> | **bitmagnet** | ✅ | A self-hosted BitTorrent indexer, DHT crawler, content classifier and torrent search engine with web UI, GraphQL API and Servarr stack integration. |
...
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/jts3servermod.png" width="48" height="36" /> | **jts3servermod 🆕** | ⚠️ | JTS3ServerMod by Stefan1200 |
...
| <img src="https://truecharts.org/img/hotlink-ok/chart-icons/teamspeak3.png" width="48" height="36" /> | **teamspeak3 🆕** | ✅ | TeamSpeak is software for quality voice communication via the Internet. |
