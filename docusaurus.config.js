...
const config = {
  ...
  organizationName: 'stevenmcelligott', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/StevenMcElligott/docs/blob/main/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/stevenmcelligott/docs',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'Twitter',
                href: 'https://twitter.com/SteveLMcE',
              },
            ],
          },
          {
